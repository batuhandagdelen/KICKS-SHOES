...
const Hero: FC = () => {
  return (
    <div className="relative">
      <div className="absolute top-1/2 -translate-y-1/2 p-4 lg:pl-10 max-md:pt-12 max-w-[68%]">
      ...
      <img
        src="/banner.png"
        alt="banner"
        className="w-full object-cover min-h-[240px] rounded-2xl sm:rounded-3xl md:rounded-4xl xl:rounded-[48px]"
      />
    </div>
  );
};
